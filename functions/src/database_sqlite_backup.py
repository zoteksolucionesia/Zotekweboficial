    ...
    demo_clients = [
        {
            ...
            "email": "demo@zotek.ia",
            "response_type": "text",
            "gemini_prompt": "Eres el asistente virtual experto de GourmetBot 2026. Eres el asistente virtual experto del Restaurante 'La Mesa Elegante'. Tu objetivo es tomar pedidos, gestionar reservas y resolver dudas. Responde de manera amable, rápida y apetitosa.",
            "created_at": "2024-01-01 00:00:00",
            "menu_json": '{"text": "¡Bienvenido a *GourmetBot 2026*! 👋 Soy tu asistente virtual del restaurante \'La Mesa Elegante\'. ¿Qué te gustaría hacer hoy?", "options": [{"title": "Ver Menú", "icon": "🍕", "response": "Nuestro menú incluye pizzas a la leña, pastas frescas y postres italianos."}, {"title": "Hacer Reserva", "icon": "📅", "response": "Indícanos la fecha y hora para verificar disponibilidad."}, {"title": "Horarios", "icon": "⏰", "response": "Estamos abiertos todos los días de 12:00 PM a 11:00 PM."}], "fallback_text": "Lo siento, no entendí eso. Aquí tienes las opciones principales de GourmetBot 2026:"}'
        },
        {
            "id": 9992, 
...
def get_client_by_id(client_id):
    ...
    demo_ids = {
        9991: {
            ...
            "phone_number_id": "demo_restaurante",
            "email": "demo@zotek.ia",
            "system_instruction": "Eres el asistente virtual experto de GourmetBot 2026. Eres el asistente virtual experto del Restaurante 'La Mesa Elegante'. Tu objetivo es tomar pedidos, gestionar reservas y resolver dudas. Responde de manera amable, rápida y apetitosa.",
            "menu_json": '{"text": "¡Bienvenido a *GourmetBot 2026*! 👋 Soy tu asistente virtual del restaurante \'La Mesa Elegante\'. ¿Qué te gustaría hacer hoy?", "options": [{"title": "Ver Menú", "icon": "🍕", "response": "Nuestro menú incluye pizzas a la leña, pastas frescas y postres italianos."}, {"title": "Hacer Reserva", "icon": "📅", "response": "Indícanos la fecha y hora para verificar disponibilidad."}, {"title": "Horarios", "icon": "⏰", "response": "Estamos abiertos todos los días de 12:00 PM a 11:00 PM."}], "fallback_text": "Lo siento, no entendí eso. Aquí tienes las opciones principales de GourmetBot 2026:"}'
        },
        9992: {
            "id": 9992, 
